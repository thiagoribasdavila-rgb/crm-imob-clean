...
import {
  CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_SCHEMA,
...
} from "./controlled-proof-execution-subsequent-continuation-observation-review-authorization.mjs";

export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_POLICY_SCHEMA =
  "atlas.controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-policy.v1";
export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_RECEIPT_SCHEMA =
  "atlas.controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-receipt.v1";
export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_SCHEMA =
  "atlas.controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-memory.v1";
export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_ENTRY_SCHEMA =
  "atlas.controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-memory-entry.v1";
export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_SIGNATURE_ALGORITHM = "ed25519";
export const CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMER_ROLE =
  "subsequent-continuation-observation-review-authorization-consumer";
...
function authorizationPolicyContext(args) {
  const {
    ...
    controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy: _consumptionPolicy,
    controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory: _consumptionMemory,
...
function normalizeConsumer(consumer) {
  ...
  if (consumer.role !== CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMER_ROLE) {
...
export function createControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy({
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationPolicy: authorizationPolicy,
  trustedReviewAuthorizationConsumers = [],
  ...upstream
}) {
  const authorizationInspection = inspectControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationPolicy(
    authorizationPolicy,
  ...
  const payload = {
    schema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_POLICY_SCHEMA,
    ...
    requiredReviewAuthorizationSchema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_SCHEMA,
    requiredMemoryEntrySchema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_ENTRY_SCHEMA,
    authorizationConsumerRole: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMER_ROLE,
    signatureAlgorithm: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_SIGNATURE_ALGORITHM,
...
export function inspectControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy(policy, context) {
  try {
    const recreated = createControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy(context);
...
function memoryPayload({ policy, entries }) {
  return {
    schema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_SCHEMA,
...
export function createControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory({ policy, entries = [] }) {
  if (policy?.schema !== CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_POLICY_SCHEMA) {
  ...
  for (const [index, entry] of entries.entries()) {
    if (entry?.schema !== CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_ENTRY_SCHEMA) {
    ...
    for (const field of [
      ...
      "subsequentContinuationReceiptHash", "subsequentContinuationPolicyHash",
      "subsequentContinuationMemoryHash", "packageSha256", "inventoryHash",
...
export function inspectControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory(memory, { policy }) {
  try {
    const recreated = createControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory({ policy, entries: memory?.entries });
...
function verifyContext(args) {
  const policyInspection = inspectControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy(
...
function authorizationInspectionContext(args) {
  const {
    controlledProofExecutionSubsequentContinuationObservationReviewAuthorization: _authorization,
    controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy: _consumptionPolicy,
    controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory: _consumptionMemory,
    trustedReviewAuthorizationConsumers: _consumers,
...
function signingPayload({ authorization, authorizationMemory, consumptionPolicy, consumptionMemoryHashBefore, consumptionId, consumer, consumedAt, nonce }) {
  ...
  return {
    signingSchema: "atlas.controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-signing-payload.v1",
    ...
    subsequentContinuationObservationReceiptHash: authorization.subsequentContinuationObservationReceiptHash,
    subsequentContinuationObservationPolicyHash: authorization.subsequentContinuationObservationPolicyHash,
    subsequentContinuationObservationMemoryHash: authorization.subsequentContinuationObservationMemoryHash,
    subsequentContinuationReceiptHash: authorization.subsequentContinuationReceiptHash,
    subsequentContinuationPolicyHash: authorization.subsequentContinuationPolicyHash,
    subsequentContinuationMemoryHash: authorization.subsequentContinuationMemoryHash,
    ...
    subsequentContinuationId: authorization.subsequentContinuationId,
...
export function consumeControlledProofExecutionSubsequentContinuationObservationReviewAuthorization({
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorization: authorization,
  ...
  const unsigned = {
    schema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_RECEIPT_SCHEMA,
    ...payload,
    signatureAlgorithm: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_SIGNATURE_ALGORITHM,
  ...
  const entryPayload = {
    schema: CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_MEMORY_ENTRY_SCHEMA,
...
export function inspectControlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionReceipt(receipt, {
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorization: authorization,
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationMemory: authorizationMemory,
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionPolicy: consumptionPolicy,
  controlledProofExecutionSubsequentContinuationObservationReviewAuthorizationConsumptionMemory: consumptionMemory,
  ...
  try {
    if (receipt?.schema !== CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_RECEIPT_SCHEMA) {
    ...
    if (receipt.signatureAlgorithm !== CONTROLLED_PROOF_EXECUTION_SUBSEQUENT_CONTINUATION_OBSERVATION_REVIEW_AUTHORIZATION_CONSUMPTION_SIGNATURE_ALGORITHM || typeof receipt.signature !== "string") {
