...
const waveDefinitions: Array<Omit<EvolutionWave, "range">> = [
  ...
  { id: 4, name: "Design system premium", outcome: "Componentes previsíveis, limpos e consistentes.", href: "/dashboard", pillar: "experiência" },
  ...
  { id: 20, name: "Performance percebida", outcome: "Telas críticas respondem imediatamente e carregam por prioridade.", href: "/activity", pillar: "plataforma" },
  ...
  { id: 22, name: "Segurança sem atrito", outcome: "Proteções fortes preservam fluidez, tenant e hierarquia.", href: "/settings", pillar: "plataforma" },
  ...
  { id: 24, name: "Homologação por jornada", outcome: "Cada fluxo é comprovado com usuário, dado e integração reais.", href: "/developments/homologation", pillar: "homologação" },
  { id: 25, name: "Produção e escala SaaS", outcome: "Release, rollback, custo e crescimento ficam controlados.", href: "/settings", pillar: "homologação" },
  ...
  { id: 27, name: "Central de atenção", outcome: "Alertas são priorizados, agrupados e convertidos em ação.", href: "/activity", pillar: "experiência" },
  ...
  { id: 42, name: "Forecast explicável", outcome: "Previsões mostram evidência, incerteza e ação recomendada.", href: "/reports", pillar: "inteligência" },
  ...
  { id: 44, name: "Agentes e automações", outcome: "Trabalho repetitivo é automatizado com aprovação e rastreabilidade.", href: "/ai-dashboard", pillar: "inteligência" },
  ...
  { id: 47, name: "Privacidade e LGPD", outcome: "Consentimento, finalidade, retenção e exclusão ficam controlados.", href: "/settings", pillar: "plataforma" },
  { id: 48, name: "Planos e monetização SaaS", outcome: "Start, Pro e Enterprise possuem valor, limites e custos claros.", href: "/reports", pillar: "plataforma" },
  { id: 49, name: "Customer Success", outcome: "Adoção, saúde da conta e valor percebido são medidos continuamente.", href: "/settings", pillar: "homologação" },
  { id: 50, name: "Otimização contínua", outcome: "Telemetria e feedback alimentam o próximo ciclo sem inflar o produto.", href: "/ai-dashboard", pillar: "homologação" },
  ...
  { id: 54, name: "Prontidão financeira", outcome: "Orçamento e financiamento são triados com limites e validação especializada.", href: "/sales", pillar: "operação" },
  ...
  { id: 60, name: "Proposta assistida", outcome: "Fluxo de pagamento, unidade e concessões passam por revisão antes do envio.", href: "/activity", pillar: "operação" },
  ...
  { id: 66, name: "Operação noturna supervisionada", outcome: "Leads fora do horário são preparadas sem contato indevido ou promessa comercial.", href: "/ai-dashboard", pillar: "inteligência" },
  ...
  { id: 77, name: "Avaliação de modelos", outcome: "Respostas são comparadas com conjuntos de teste e revisão humana.", href: "/ai-dashboard", pillar: "homologação" },
  ...
  { id: 80, name: "RAG imobiliário", outcome: "Conhecimento vigente é recuperado com fonte, versão e validade.", href: "/developments/materials", pillar: "inteligência" },
  { id: 81, name: "Aprendizado supervisionado", outcome: "Sugestão, decisão e resultado alimentam melhoria com aprovação humana.", href: "/ai-dashboard", pillar: "inteligência" },
  { id: 82, name: "Calibração preditiva", outcome: "Probabilidades refletem amostras observadas, incerteza e drift.", href: "/ai-dashboard", pillar: "homologação" },
  { id: 83, name: "Equidade de modelos", outcome: "Atributos protegidos não orientam score, distribuição ou tratamento.", href: "/settings", pillar: "homologação" },
  ...
  { id: 86, name: "Segurança contra prompt injection", outcome: "Dados externos nunca se tornam instruções confiáveis para agentes.", href: "/settings", pillar: "plataforma" },
  { id: 87, name: "Privacidade por finalidade", outcome: "Cada uso de dado possui finalidade, base e retenção explícitas.", href: "/settings", pillar: "plataforma" },
  ...
  { id: 96, name: "Confiabilidade de dados", outcome: "Freshness, completude e linhagem acompanham cada indicador executivo.", href: "/settings", pillar: "plataforma" },
  { id: 97, name: "Escala multi-tenant", outcome: "Crescimento de clientes preserva isolamento, desempenho e custos previsíveis.", href: "/settings", pillar: "plataforma" },
  ...
  { id: 99, name: "Homologação de receita", outcome: "Jornadas críticas são comprovadas ponta a ponta com dados e perfis reais.", href: "/developments/homologation", pillar: "homologação" },
  { id: 100, name: "Maturidade Atlas 2000", outcome: "Produto, operação, IA e receita fecham o ciclo com evidência e melhoria contínua.", href: "/settings", pillar: "homologação" },
];
