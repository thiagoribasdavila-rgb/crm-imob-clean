...
export const evolutionPhases: EvolutionPhase[] = [
  ...
  },
  {
    ...
    weight: 15,
    status: "avançada",
    evidence: ["Command Center real", "Lead 360", "Pipeline persistente", "Tarefas e agenda"],
    next: "Concluir filtros avançados de Leads e uniformizar telas operacionais legadas.",
    href: "/leads",
  },
  {
    id: 4,
