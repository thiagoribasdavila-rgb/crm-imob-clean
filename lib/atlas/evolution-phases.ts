...
export const evolutionPhases: EvolutionPhase[] = [
  ...
  },
  {
    ...
    weight: 8,
    status: "parcial",
    evidence: ["SLA por incorporadora", "Vencimento automático", "Estados pendente, próximo, atrasado, parcial, recebido e divergente", "Histórico financeiro versionado"],
    next: "Aplicar migrações, criar operação de baixa com comprovante e validar pagamentos reais com o financeiro.",
    href: "/sales",
  },
  {
    id: 12,
