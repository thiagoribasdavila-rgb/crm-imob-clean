...
export const evolutionPhases: EvolutionPhase[] = [
  {
    ...
    weight: 8,
    status: "avançada",
    evidence: ["Node 24 validado", "Doctor aprovado", "Build, lint e typecheck aprovados", "276 controles de IA, CRM, Meta e governança e 12 cenários calibrados"],
  ...
  },
  {
    ...
    weight: 9,
    status: "avançada",
    evidence: ["Copilot persistente e tenant-safe", "276 controles calibrados", "Score e matching explicáveis", "Roteamento por custo e complexidade", "Fallback local determinístico", "OpenAI + Perplexity", "Aprovação humana"],
