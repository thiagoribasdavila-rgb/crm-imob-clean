...
export const evolutionPhases: EvolutionPhase[] = [
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["Node 24 validado", "Doctor aprovado", "Build, lint e typecheck aprovados", "42 controles de IA e 12 cenários calibrados"],
  ...
  },
  {
    ...
    weight: 15,
    status: "avançada",
    evidence: ["Leads Intelligence paginado", "Lead 360", "Pipeline persistente", "Visibilidade hierárquica", "Transferência em massa"],
  ...
  },
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["Copilot tenant-safe", "42 controles calibrados", "Score e matching explicáveis", "Fallback local", "Aprendizado com feedback", "Aprovação humana"],
  ...
  },
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["App Shell oficial", "Sidebar responsiva", "Command Center premium", "Lead 360", "Matching Studio", "Cockpit gerencial"],
