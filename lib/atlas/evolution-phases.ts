...
export const evolutionPhases: EvolutionPhase[] = [
  {
    ...
    weight: 8,
    status: "avançada",
    evidence: ["Node 24 validado", "Doctor aprovado", "Build, lint e typecheck aprovados", "107 controles de IA, CRM e Meta e 12 cenários calibrados"],
  ...
  },
  {
    ...
    weight: 9,
    status: "avançada",
    evidence: ["Copilot tenant-safe", "107 controles calibrados", "Score e matching explicáveis", "Fallback local determinístico", "Aprendizado com feedback", "OpenAI + Perplexity", "Aprovação humana"],
