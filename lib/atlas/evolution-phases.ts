...
export const evolutionPhases: EvolutionPhase[] = [
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["Node 24 validado", "Doctor aprovado", "Build, lint e typecheck aprovados", "100 controles de IA, CRM e Meta e 12 cenários calibrados"],
  ...
  },
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["Copilot tenant-safe", "100 controles calibrados", "Score e matching explicáveis", "Fallback local", "Aprendizado com feedback", "OpenAI + Perplexity", "Aprovação humana"],
