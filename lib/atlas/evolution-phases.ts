...
export const evolutionPhases: EvolutionPhase[] = [
  ...
  },
  {
    ...
    weight: 10,
    status: "avançada",
    evidence: ["Copilot tenant-safe", "107 controles calibrados", "Score e matching explicáveis", "Fallback local", "Aprendizado com feedback", "OpenAI + Perplexity", "Aprovação humana"],
