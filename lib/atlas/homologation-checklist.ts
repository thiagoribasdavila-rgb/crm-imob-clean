...
export const homologationChecklist: HomologationCheck[] = [
  ...
  { key: "superintendent-portfolio-scope", role: "superintendent", title: "Auditoria das equipes", procedure: "Comparar o livro da carteira entre dois gerentes subordinados.", expected: "Eventos das equipes aparecem; estruturas paralelas e outra empresa não aparecem.", href: "/distribution" },
  ...
  { key: "manager-capacity-reservation", role: "manager", title: "Capacidade e reserva", procedure: "Definir teto baixo, distribuir e deixar uma reserva expirar.", expected: "Teto bloqueia sobrecarga e lead sem interação retorna à fila com tarefas.", href: "/distribution" },
