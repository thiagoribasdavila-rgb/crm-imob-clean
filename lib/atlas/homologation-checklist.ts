...
export const homologationChecklist: HomologationCheck[] = [
  ...
  { key: "director-hostinger-health", role: "director", title: "Saúde da Hostinger", procedure: "Validar aplicação, PM2, logs e reinício.", expected: "Serviço retorna após reinício controlado.", href: "/integrations" },
  ...
  { key: "director-api-health", role: "director", title: "APIs de saúde", procedure: "Executar health e ready no ambiente publicado.", expected: "Dependências essenciais são diagnosticadas.", href: "/atlas-v3/developer" },
