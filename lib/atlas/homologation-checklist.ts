...
export const homologationChecklist: HomologationCheck[] = [
  ...
  { key: "broker-matching", role: "broker", title: "Matching e apresentação", procedure: "Selecionar até três imóveis, gerar mensagem e abrir no WhatsApp.", expected: "Indisponíveis são bloqueados e nada é enviado automaticamente.", href: "/properties/matching" },
  { key: "broker-feedback", role: "broker", title: "Retorno do cliente", procedure: "Registrar apresentação e marcar Gostou ou Não aderiu.", expected: "Timeline e ranking são recalibrados com o retorno.", href: "/properties/matching" },
  ...
  { key: "director-tenant-isolation", role: "director", title: "Isolamento entre empresas", procedure: "Comparar acessos de duas organizações.", expected: "Nenhum dado cruza organizações.", href: "/settings" },
  { key: "director-backup", role: "director", title: "Backup de homologação", procedure: "Registrar snapshot anterior à publicação.", expected: "Restauração possui evidência e responsável.", href: "/activity" },
  { key: "director-rollback", role: "director", title: "Rollback para V2", procedure: "Simular retorno sem apagar o V3.", expected: "Plano executável dentro do tempo acordado.", href: "/activity" },
  ...
  { key: "director-domain-ssl", role: "director", title: "Domínio e SSL", procedure: "Abrir subdomínio de homologação e testar HTTPS.", expected: "Certificado válido e sem conteúdo misto.", href: "/activity" },
  { key: "director-environment-secrets", role: "director", title: "Segredos do ambiente", procedure: "Revisar variáveis sem revelar valores.", expected: "Nenhum segredo está no navegador ou repositório.", href: "/settings" },
  { key: "director-api-health", role: "director", title: "APIs de saúde", procedure: "Executar health e ready no ambiente publicado.", expected: "Dependências essenciais são diagnosticadas.", href: "/settings" },
  ...
  { key: "director-nightly-journey", role: "director", title: "Jornada após 20h", procedure: "Executar worker após 20h com lead consentido.", expected: "Abordagem entra em aprovação uma única vez.", href: "/activity" },
  ...
  { key: "superintendent-distribution-restriction", role: "superintendent", title: "Restrição da fila", procedure: "Tentar abrir /distribution diretamente.", expected: "A fila não é exibida e nenhuma configuração pode ser alterada.", href: "/dashboard" },
  { key: "superintendent-portfolio-scope", role: "superintendent", title: "Auditoria das equipes", procedure: "Comparar o livro da carteira entre dois gerentes subordinados.", expected: "Eventos das equipes aparecem; estruturas paralelas e outra empresa não aparecem.", href: "/brokers" },
  ...
  { key: "manager-distribution-restriction", role: "manager", title: "Restrição da fila", procedure: "Tentar abrir /distribution diretamente.", expected: "A fila não é exibida e nenhuma configuração pode ser alterada.", href: "/dashboard" },
  { key: "manager-project-balance", role: "manager", title: "Equilíbrio por projeto", procedure: "Comparar a carga dos corretores por empreendimento.", expected: "A liderança visualiza somente sua equipe; a distribuição é decidida pela diretoria.", href: "/brokers" },
  { key: "manager-capacity-reservation", role: "manager", title: "Capacidade da equipe", procedure: "Verificar teto, disponibilidade e ações vencidas dos corretores.", expected: "A liderança identifica sobrecarga sem alterar a fila central.", href: "/brokers" },
  ...
  { key: "manager-approval", role: "manager", title: "Aprovação de abordagem", procedure: "Aprovar e rejeitar mensagens de teste.", expected: "Somente aprovadas entram na outbox.", href: "/activity" },
  ...
  { key: "broker-lead-acceptance", role: "broker", title: "Aceite da lead", procedure: "Receber uma distribuição e aceitar pela Lead 360.", expected: "Aceite ocorre no prazo, preserva responsável único e aparece no histórico.", href: "/leads" },
