...
const checks = [
  ...
  [
    "Falha parcial não expõe detalhe técnico",
    decisionCenter.includes("Seus dados")
      && decisionCenter.includes("permanecem protegidos")
      && !decisionCenter.includes("leadResult.error.message"),
  ],
