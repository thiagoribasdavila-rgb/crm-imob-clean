...
if (failed) throw new Error(`controlled_external_publication_execution_permit_consumption_context_invalid:${failed.reason}`);

console.log(JSON.stringify({
  schema: "atlas.controlled-external-publication-execution-permit-consumption-readiness.v1",
  phase: 226,
  compositionId: permitConsumptionPolicy.compositionId,
  ...
  trustedPermitConsumersConfigured: permitConsumptionPolicy.trustedPermitConsumers.length,
  ...
  recordedPermitConsumptions: permitConsumptionMemory.summary.recordedConsumptions,
  consumedSingleUsePermits: permitConsumptionMemory.summary.consumedSingleUsePermits,
  distinctPermits: permitConsumptionMemory.summary.distinctPermits,
  readiness: "awaiting_recorded_unexpired_single_use_permit_and_target_external_executor",
  permitConsumptionAllowed: permitConsumptionPolicy.permitConsumptionAllowed,
