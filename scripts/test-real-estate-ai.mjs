...
const checks = [
  ...
  ["roadmap registra evolução da IA", evolutionPhases.includes('name: "IA funcional"') && evolutionPhases.includes("288 controles calibrados") && evolutionPhases.includes("Fallback local determinístico")],
