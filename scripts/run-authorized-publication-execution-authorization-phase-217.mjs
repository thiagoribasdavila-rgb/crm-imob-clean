...
if (failed) throw new Error(`authorized_publication_execution_authorization_context_invalid:${failed.reason}`);

console.log(JSON.stringify({
  schema: "atlas.authorized-publication-execution-authorization-readiness.v1",
  phase: 217,
  ...
  readiness: "awaiting_approved_publication_decision_and_independent_execution_authorizer",
