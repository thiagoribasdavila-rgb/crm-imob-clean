...
if (process.argv.includes("--generate")) {
  const policy = createControlledProofExecutionNextSubsequentContinuationObservationReviewPolicy(
    nextObservationReviewPolicyContext,
  );
  const memory = createControlledProofExecutionNextSubsequentContinuationObservationReviewMemory({ policy });
...
console.log(JSON.stringify({
  schema: "atlas.controlled-proof-execution-next-subsequent-continuation-observation-review-readiness.v1",
  phase: 243,
  compositionId: nextObservationReviewPolicy.compositionId,
  ...
  nextSubsequentContinuationObservationReviewAllowed:
    nextObservationReviewPolicy.nextSubsequentContinuationObservationReviewAllowed,
  nextSubsequentContinuationObservationAccepted:
    nextObservationReviewMemory.summary.nextSubsequentContinuationObservationAccepted,
