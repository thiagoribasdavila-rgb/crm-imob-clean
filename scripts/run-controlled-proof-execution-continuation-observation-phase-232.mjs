...
if (failed) throw new Error(`controlled_proof_execution_continuation_observation_context_invalid:${failed.reason}`);

console.log(JSON.stringify({
  schema: "atlas.controlled-proof-execution-continuation-observation-readiness.v1",
  phase: 232,
  compositionId: continuationObservationPolicy.compositionId,
  ...
  trustedContinuationObserversConfigured: continuationObservationPolicy.trustedContinuationObservers.length,
  ...
  observedContinuations: continuationObservationMemory.summary.observedContinuations,
  readiness: "awaiting_valid_recorded_continuation_and_trusted_independent_continuation_observer",
  controlledProofExecutionContinuationObservationAllowed: continuationObservationPolicy.controlledProofExecutionContinuationObservationAllowed,
  controlledProofExecutionContinuationObserved: continuationObservationMemory.summary.controlledProofExecutionContinuationObserved,
