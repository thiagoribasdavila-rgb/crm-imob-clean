...
if (packageConfig.engines?.node !== ">=22") errors.push("runtime oficial deve aceitar Node.js 22+");
...
console.log("ATLAS ENVIRONMENTS: PASSED (development, homologation e production isolados; Node.js 22+)");
