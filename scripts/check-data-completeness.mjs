...
if (!endpoint.includes("assessLeadCompleteness") || !endpoint.includes("requireLeadAccess") || !endpoint.includes("weighted_commercial_completeness_v1")) failures.push("avaliação não está ligada ao Lead 360 seguro");
for (const marker of ['data-phase="30-data-gaps"', "Pergunte menos", "Pergunte agora", "qualifyLead", "actOnGap", "não gera custo de IA"]) if (!page.includes(marker)) failures.push(`experiência ausente: ${marker}`);
