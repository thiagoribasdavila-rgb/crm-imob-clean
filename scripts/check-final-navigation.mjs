...
need("components/atlas/mobile-dock.tsx", 'aria-label="Navegação e ação rápida"', "getAtlasTaskActionForPathname", 'aria-current');
need("components/atlas/topbar.tsx", "atlas:open-command-palette", 'aria-label="Buscar em toda a plataforma"');
need("components/atlas/sidebar.tsx", "visibleItems", "getAtlasNavigationForIdentity", 'aria-current');
need("components/atlas/sidebar.tsx", "ATLAS ONE", "Operação conectada", 'data-navigation-style="atlas-one-canonical"');
need("components/atlas/topbar.tsx", "Atlas One conectado", "Operação segura");
