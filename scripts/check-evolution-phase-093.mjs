...
const checks = [
  ...
  ["Inventário cobre todas as 271 páginas", pageFiles.length === 271 && classification.unclassified === undefined],
  ...
  ["Evolução V3 permanece interna e fora do menu diário", internalNavigationItems === 1 && !primaryNavigationSource.includes('href: "/atlas-v3"') && navigation.includes("atlasInternalNavigation")],
