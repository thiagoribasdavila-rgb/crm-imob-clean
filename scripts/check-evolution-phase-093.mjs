...
const checks = [
  ...
  ["Inventário cobre todas as páginas-fonte", pageFiles.length === phase.routeInventory.pageFiles && classification.unclassified === undefined],
  ...
  ["Navegação produtiva possui 19 contratos canônicos", canonicalNavigationItems === 19 && phase.navigation.productiveItems === 19],
  ["Evolução V3 permanece fora do menu diário", internalNavigationItems === 0 && !primaryNavigationSource.includes('href: "/atlas-v3"') && navigation.includes("atlasInternalNavigation")],
