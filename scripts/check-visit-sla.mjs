...
const readsTasks =
  calendarApi.includes('from("tasks")') ||
  calendarApi.includes("readCompatibleTasks");
const readsVisits = calendarApi.includes('from("lead_visits")');
if(!readsTasks||!readsVisits||!calendar.includes("Tarefas, visitas e follow-ups permanecem em uma única")||!calendar.includes('data-calendar-layout="time-first"'))failures.push("calendário não unifica tarefas e visitas");
