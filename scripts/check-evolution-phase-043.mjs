...
const checks = [
  ...
  ["Reativação declara decisão como primeira leitura", page.includes('data-evolution-foundation-phase="43"') && page.includes('data-reactivation-layout="decision-first"')],
