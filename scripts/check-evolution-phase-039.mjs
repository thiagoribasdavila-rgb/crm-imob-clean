...
const checks = [
  ...
  ["Agenda declara hierarquia temporal", calendar.includes('data-evolution-phase="39"') && calendar.includes('data-calendar-layout="time-first"') && calendar.includes("Seu tempo comercial, em ordem")],
  ...
  ["Contrato legado da Agenda permanece identificável", calendar.includes('data-phase="46-commercial-calendar') && calendar.includes("Tarefas, visitas e follow-ups permanecem em uma única")],
