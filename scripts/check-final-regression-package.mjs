...
// O empacotador Hostinger passou a nomear o artefato por padrão como
// atlas-v3-hostinger-homologation.zip (canal homologação limpa, prod intocada),
// substituindo o antigo atlas-v3-hostinger-final.zip. O pipeline de release
// segue validado (git archive, sem dado privado, sha256, redirect seguro).
need("scripts/package-hostinger.mjs", 'execFileSync("git", ["archive"', "privateDataIncluded: false", "RELEASE_FILES.sha256", "atlas-v3-hostinger-homologation.zip", '"lib/auth/safe-redirect.ts"', '"components/crm/lead-operational-bar.tsx"');
