...
for(const marker of ['data-phase="56-forecast-measurement"',"Composição do forecast","Quando o pipeline pode maturar","Confiança mede completude","receita garantida"])if(!page.includes(marker))failures.push(`experiência incompleta: ${marker}`);
