...
const checks = [
  ...
  ["Atribuição continua exigindo clique humano", /onClick=\{\(\)\s*=>\s*void distribute\(1\)\}/m.test(page) && page.includes("decisão explícita da liderança") && config.safetyPolicy.explicitLeadershipActionRequired === true],
