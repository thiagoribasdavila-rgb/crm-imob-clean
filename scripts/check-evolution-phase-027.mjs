...
const checks = [
  ...
  ["Quatorze transições contextuais estão governadas", taskActionCount === 14 && taskTargetCount === 14 && config.taskActions.contextualTransitions === 14],
  ...
  ["Relatório documenta fonte, responsividade e limite", report.includes("14 transições") && report.includes("Ação desta tela") && report.includes("não comprova redução real de tempo") && report.includes("Fase 028")],
