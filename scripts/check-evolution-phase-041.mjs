...
const checks = [
  ...
  ["Clientes 360 declara relacionamento como primeira leitura", customers.includes('data-customers-layout="relationship-first"') && customers.includes("FASE 41 · RELACIONAMENTO 360")],
