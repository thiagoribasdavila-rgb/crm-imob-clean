...
const executionAuthorizationMemory = readJson("config/authorized-publication-execution-authorization-memory.json");
...
if (failed) throw new Error(`authorized_publication_execution_context_invalid:${failed.reason}`);

console.log(JSON.stringify({
  schema: "atlas.authorized-publication-execution-readiness.v1",
  phase: 218,
  ...
  trustedExecutionAuthorizersConfigured: executionAuthorizationPolicy.trustedExecutionAuthorizers.length,
  trustedPublicationExecutorsConfigured: executionPolicy.trustedExecutors.length,
  trustedPublicationHandlersConfigured: executionPolicy.trustedPublicationHandlers.length,
  recordedPublicationDecisions: publicationMemory.summary.recordedDecisions,
  approvedPublicationDecisions: publicationMemory.summary.authorizedPackages,
  executionAuthorizations: executionAuthorizationMemory.summary.recordedAuthorizations,
  ...
  readiness: "awaiting_recorded_execution_authorization_and_independent_publication_executor",
  executionAuthorized: false,
  publicationProofExecuted: false,
