...
- `lib/release/controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption.mjs`
- `tests/contracts/controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption.test.mjs`
- `config/controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-policy.json`
- `config/controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-memory.json`
- `config/evolution-phase-240-controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption.json`
- `scripts/run-controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption-phase-240.mjs`
- `scripts/check-evolution-phase-240.mjs`
...
```bash
node --test tests/contracts/controlled-proof-execution-subsequent-continuation-observation-review-authorization-consumption.test.mjs
npm run evolution:phase-240:assess
npm run evolution:phase-240:check
```

## Próxima fase

Fase 241 — `Controlled Proof Execution Next Subsequent Continuation`: executar a próxima continuação interna somente a partir de um consumo válido, assinado e registrado, ainda sem publicação ou efeitos externos.
