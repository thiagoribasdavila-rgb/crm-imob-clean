...
export default function BrokersPage() {
  ...
  return (
    <div className="space-y-4 pb-10" data-evolution-phase="45" data-team-layout="conversion-support">
      ...
      {/* ── ESTADO NÃO DIZ SE O FUNIL ESTÁ SENDO ALIMENTADO ─────────────────
          Tudo nesta tela até aqui é ESTADO da carteira (quantas, quentes,
          atrasadas, sem próxima ação). Uma carteira pode estar impecável nesses
          números porque as leads SAÍRAM do funil — e foi o que aconteceu:
          medido em 02/08/2026, 404 das 413 saídas registradas partiram da etapa
          "Novos" (e em 402 delas o ledger inteiro nunca registrou passagem por
          "Contato" — duas voltaram de "Contato" para "Novos" antes de sair).

          Este bloco lê a movimentação e não o estado. Fica DEPOIS da fila de
          apoio, que trata de gente esperando agora, e ANTES da estrutura, que é
          consulta. ── */}
      {!error ? (
