...
export default function MetaIntegration() {
  ...
  return <div className="space-y-6 pb-12">
    ...
    <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
      ...
      <AtlasMetric label="Conversão final" value={data ? `${data.funnelInsights.convertedRate}%` : "—"} detail={`${data?.funnelInsights.lost ?? 0} perdas na memória interna`} trend="FUNIL" tone="rose" />
    </section>
