...
type Payload = { sources: Source[]; summary: Record<string, number>; conversionConfig: ConversionConfig; conversionSummary: Record<string, number>; readiness: { webhookSecret: boolean; graphToken: boolean; conversionsToken: boolean; cronWorker: boolean }; canManage: boolean };
