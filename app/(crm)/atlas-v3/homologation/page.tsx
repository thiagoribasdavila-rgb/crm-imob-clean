...
type Payload = { checks: HomologationCheck[]; results: Result[]; readiness: { overallEvolution: number; technicalEvolution: number; aiCalibration: { percent: number; controls: number; scenarios: number; next: string; dimensions: Array<{ name: string; percent: number }> }; phases: EvolutionPhase[] }; currentUser: { id: string; commercialRole: HomologationRole } };
