...
export default function ReactivationGovernancePage() {
  ...
  return <div className="space-y-6 pb-10" data-evolution-phase="89-consented-reactivation-governance" data-evolution-foundation-phase="43" data-reactivation-layout="decision-first">
    <section className="atlas-grid-glow rounded-[30px] border border-emerald-400/10 bg-gradient-to-br from-emerald-500/[.1] via-blue-500/[.08] to-violet-500/[.1] p-6 sm:p-8">
      ...
      <div className="mt-5 grid gap-2 sm:grid-cols-3" aria-label="Proteções obrigatórias da reativação">
        <div className="rounded-2xl border border-emerald-300/15 bg-emerald-400/[.06] px-4 py-3 text-xs font-semibold tracking-[.08em] text-emerald-100">WHATSAPP OFICIAL</div>
        <div className="rounded-2xl border border-sky-300/15 bg-sky-400/[.06] px-4 py-3 text-xs font-semibold tracking-[.08em] text-sky-100">CONSENTIMENTO OBRIGATÓRIO</div>
        <div className="rounded-2xl border border-violet-300/15 bg-violet-400/[.06] px-4 py-3 text-xs font-semibold tracking-[.08em] text-violet-100">RESPOSTA INTERROMPE CADÊNCIA</div>
      </div>
