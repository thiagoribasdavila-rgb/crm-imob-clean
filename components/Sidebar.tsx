      ...
      <aside className="fixed inset-y-0 left-0 z-40 hidden w-[292px] border-r border-white/[0.07] bg-[#060a14]/95 lg:flex lg:flex-col lg:backdrop-blur-2xl">
        <div className="border-b border-white/[0.07] px-6 py-6">
          <Link href="/dashboard" className="group flex items-center gap-3">
            ...
            <span><span className="block text-xl font-black tracking-[-.04em] text-white">ATLAS <span className="text-sky-400">AI</span></span><span className="block text-micro font-semibold uppercase tracking-[.22em] text-slate-500">Inteligência comercial</span></span>
          </Link>
        </div>
        ...
        <div className="mx-4 mt-4 rounded-2xl border border-cyan-400/15 bg-gradient-to-br from-cyan-500/[.09] via-blue-500/[.08] to-violet-500/[.08] p-4">
          <div className="flex items-center justify-between"><span className="text-micro font-bold uppercase tracking-[.18em] text-cyan-300">Atlas 2030</span><span className="rounded-full border border-emerald-400/20 bg-emerald-400/10 px-2 py-1 text-micro font-bold text-emerald-300">ACTIVE</span></div>
